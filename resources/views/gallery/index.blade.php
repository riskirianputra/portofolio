                ...
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">UPLOAD GAMBAR</h5>
                    ...
                    {{ csrf_field() }}                                                            
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12 {{ $errors->has('nama_gallery') ? ' has-error' : '' }}">  
                                    <input id="nama_gallery" type="text" class="form-control" name="nama_gallery" value="" placeholder="nama gallery">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center mt-4">
                            ...
                            <h4 class="">{{ $gallery->nama_gallery }}</h4>
                        </div>
                    </div>
                </div>
            </div>
