...
<div>
    <div class="alert alert-secondary mx-4" role="alert">
        <span class="text-white">
            <strong>Add, Edit, Delete Pendidikan!</strong>             
        </span>
    </div>
            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0"> ALL Pendidikan</h5>
                        </div>
                        <a href="{{ route('pendidikan.create') }}" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp; New Pendidikan</a>                                           
                    </div>
                </div>
